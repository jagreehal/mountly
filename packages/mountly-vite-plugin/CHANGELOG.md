...
- 45e067a: Script embeds gain three features.
...
- 1c8d709: Add `shadow: true` to `defineElementsConfig`. Every element in the distribution
...
- 1c8d709: Add script-tag component distributions. `defineElementsConfig({ prefix, elements })` takes a
