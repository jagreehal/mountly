...
- Updated dependencies [490a27f]
  - mountly@1.3.0
  - mountly-compose@0.1.0
...
- bffdef2: Phase 3: View-first API, one-package React install, chat-shaped host.
...
- 1ef012b: Make the json-render MCP integration wire-compatible with `@json-render/mcp`, and bump `@json-render/core`/`@json-render/react` to 0.20.
