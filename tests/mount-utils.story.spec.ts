...
test.describe("Mount utils story", () => {
  test("safeUnmount clears mounted output and removes container", async ({ page }, testInfo) => {
    ...
    story.given("an empty fixture page and a mount container with attached unmount callback");
    ...
    story.then("the unmount callback is called once and the container is removed");
