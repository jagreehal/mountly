...
const OVERVIEW = {
  root: "root",
  elements: {
    root: { type: "Stack", props: { gap: 22 }, children: ["h", "kpis", "quarter", "div", "badges", "foot"] },
    ...
    s1: { type: "Stat", props: { label: "MRR", value: "$48.2k", trend: "up", delta: "+12.4%" }, children: [] },
    sp1: { type: "Sparkline", props: { points: [38, 40, 39, 43, 45, 47, 48.2], tone: "accent" }, children: [] },
    c2: { type: "Card", props: {}, children: ["s2", "sp2"] },
    s2: { type: "Stat", props: { label: "Active customers", value: "1,284", trend: "up", delta: "+3.1%" }, children: [] },
    sp2: { type: "Sparkline", props: { points: [1180, 1205, 1220, 1240, 1262, 1275, 1284], tone: "positive" }, children: [] },
    c3: { type: "Card", props: {}, children: ["s3", "sp3"] },
    s3: { type: "Stat", props: { label: "Gross margin", value: "75%", trend: "up", delta: "+1.2pt" }, children: [] },
    sp3: { type: "Sparkline", props: { points: [71, 72, 72, 73, 74, 74, 75], tone: "accent" }, children: [] },
    ...
    qstat: { type: "Stat", props: { label: "Q3 bookings", value: "$612k", trend: "up", delta: "+18%" }, children: [] },
    qspark: { type: "Sparkline", props: { points: [180, 210, 240, 280, 330, 410, 612], tone: "accent" }, children: [] },
    qbtn: { type: "Button", props: { label: "Break down Q3 by region  →", variant: "primary" }, children: [], on: { press: { action: "ask", params: { prompt: "Show me the Q3 revenue breakdown by region" } } } },
    ...
    foot: { type: "Text", props: { text: "Streamed live from one prompt — every card you see was generated, not hand-coded.", muted: true }, children: [] },
  },
};
...
const Q3 = {
  ...
  elements: {
    ...
    nast: { type: "Stat", props: { label: "North America", value: "$284k", trend: "up", delta: "+22%" }, children: [] },
    nasp: { type: "Sparkline", props: { points: [120, 150, 170, 190, 230, 260, 284], tone: "positive" }, children: [] },
    nabg: { type: "Badge", props: { text: "Top region", tone: "positive" }, children: [] },
    emea: { type: "Card", props: {}, children: ["emst", "emsp"] },
    emst: { type: "Stat", props: { label: "EMEA", value: "$201k", trend: "up", delta: "+14%" }, children: [] },
    emsp: { type: "Sparkline", props: { points: [130, 140, 155, 165, 180, 192, 201], tone: "accent" }, children: [] },
    apac: { type: "Card", props: {}, children: ["apst", "apsp", "apbg"] },
    apst: { type: "Stat", props: { label: "APAC", value: "$127k", trend: "up", delta: "+31%" }, children: [] },
    apsp: { type: "Sparkline", props: { points: [60, 72, 80, 95, 108, 118, 127], tone: "positive" }, children: [] },
    apbg: { type: "Badge", props: { text: "Fastest growing", tone: "warning" }, children: [] },
    deal: { type: "Card", props: { title: "Largest expansion", accent: true }, children: ["dealt", "dealbg"] },
    dealt: { type: "Text", props: { text: "Northwind Trading — $84k expansion, closed by the EMEA team." }, children: [] },
    dealbg: { type: "Badge", props: { text: "Closed won", tone: "positive" }, children: [] },
    nav: { type: "Row", props: { gap: 12 }, children: ["back", "next"] },
    back: { type: "Button", props: { label: "←  Overview", variant: "ghost" }, children: [], on: { press: { action: "ask", params: { prompt: "Show the revenue overview" } } } },
    next: { type: "Button", props: { label: "Forecast Q4  →", variant: "primary" }, children: [], on: { press: { action: "ask", params: { prompt: "Show the Q3 revenue breakdown by region" } } } },
  },
};
