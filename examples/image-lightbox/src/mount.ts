...
import { ImageLightbox, type ImageLightboxData } from "./Component.js";
...
export function mountImageLightbox(
  ...
  props: { data: ImageLightboxData; onClose?: () => void }
): void {
...
export function updateImageLightbox(
  container: HTMLElement,
  props: { data: ImageLightboxData; onClose?: () => void }
): void {
...
export function unmountImageLightbox(container: HTMLElement): void {
