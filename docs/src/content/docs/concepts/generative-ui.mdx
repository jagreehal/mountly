---
title: Generative UI
description: Render @json-render specs as MCP Apps Views, with the agent-action bridge — an AI emits a UI spec, mountly renders it as real native components inside an agent host.
---
