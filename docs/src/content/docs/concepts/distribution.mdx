...
| Use case                                | Pick               | Why                                             |
| --------------------------------------- | ------------------ | ----------------------------------------------- |
| One widget on a page, host has no React | **Self-contained** | Zero wiring; ~66 KB gz                          |
| Two or more widgets on the same page    | **Shared React**   | One copy of React; ~3 KB gz per widget          |
