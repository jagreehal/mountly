...
By default, the widget mounts inside the element itself. To mount into a sibling instead, pass `mount-selector`. This helps when the trigger element should stay tiny and the widget renders into a pre-positioned container:
