...
description: The <mountly-feature> element — how a manifest host renders independently-deployed verticals as tags.
---
...
Most hosts do not write that list by hand — they generate it from a manifest with
