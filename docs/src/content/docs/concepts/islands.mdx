...
| **Custom element form integration** | Full-page app or default light DOM | If you need native form submission or deep form API integration, full-page apps handle this natively. Light DOM (the mountly default) lets the form APIs work without extra plumbing. |
