...
Host entry, in the island form, which needs no page JavaScript:
...
The scaffolder lays down the runtime, the React adapter, the build pipeline, and a working host page:
