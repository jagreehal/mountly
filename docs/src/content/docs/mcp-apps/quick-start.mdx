...
Or install [Agent Skills](/mcp-apps/agent-skills/) and ask an agent to create
...
Next: [Build and artifacts](/mcp-apps/build-and-artifacts/),
[Production integration](/mcp-apps/production-integration/).
