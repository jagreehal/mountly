...
```html
<mountly-feature module-id="signup" trigger="hover" props='{"plan":"pro"}'></mountly-feature>
```
...
**Live:** [self-contained host]({exampleUrl("plain-html/")}) · [shared React host]({exampleUrl("plain-html/shared-react.html")})
