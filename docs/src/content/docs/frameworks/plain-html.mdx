...
mountly's most distinctive use case is **plain HTML hosts** — CMS pages, partner integrations, static sites. No bundler. No SPA. Use declarative islands plus one host script tag.
