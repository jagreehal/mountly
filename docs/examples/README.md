...
9. **`json-render-mcp/`** — Minimal `createJsonRenderMcpApp` integration blueprint (catalog + MCP tool/resource + iframe hook). See [json-render-mcp/README.md](json-render-mcp/README.md).
