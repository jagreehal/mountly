...
export const SAMPLE_SPECS = {
  revenue: {
    ...
    elements: {
      ...
      s1: {
        type: "Stat",
        props: { label: "Total revenue", value: "$48,200", trend: "up", delta: "+12%" },
        children: [],
      },
      c2: { type: "Card", props: {}, children: ["s2"] },
      s2: {
        type: "Stat",
        props: { label: "Active customers", value: "1,284", trend: "up", delta: "+3%" },
        children: [],
      },
      c3: { type: "Card", props: {}, children: ["s3"] },
      s3: {
        type: "Stat",
        props: { label: "Gross margin", value: "75%", trend: "up", delta: "+1pt" },
        children: [],
      },
  ...
  growth: {
    ...
    elements: {
      ...
      s1: {
        type: "Stat",
        props: { label: "New signups", value: "342", trend: "up", delta: "+8%" },
        children: [],
      },
      c2: { type: "Card", props: {}, children: ["s2"] },
      s2: {
        type: "Stat",
        props: { label: "Churn", value: "2.1%", trend: "down", delta: "-0.4%" },
        children: [],
      },
    },
  },
