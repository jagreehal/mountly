...
import { PaymentBreakdown, type PaymentBreakdownData } from "./Component.js";
...
const widget = createWidget(PaymentBreakdown, { shadow: true, styles });
...
export function mountPaymentBreakdown(
  container: HTMLElement,
  props: { data: PaymentBreakdownData; onClose?: () => void },
): void {
...
export function updatePaymentBreakdown(
  container: HTMLElement,
  props: { data: PaymentBreakdownData; onClose?: () => void },
): void {
...
export function unmountPaymentBreakdown(container: HTMLElement): void {
