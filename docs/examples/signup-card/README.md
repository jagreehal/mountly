...
<script type="importmap">
  {
    "imports": {
      ...
      "signup-card":../docs/examples/signup-card/dist/peer.js"
    }
  }
</script>
...
Paths above assume the HTTP server’s document root is the **repository root** (same as `docs/examples/plain-html` and `docs/examples/marketing-site`). Published sites replace those URLs with your CDN or asset host.
