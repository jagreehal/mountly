...
export const signupCard = createOnDemandFeature({
  ...
  loadModule: async () => ({
    mount: mod.mountSignupCard as (container: HTMLElement, props: Record<string, unknown>) => void,
...
export { mountSignupCard, unmountSignupCard, updateSignupCard } from "./mount.js";
