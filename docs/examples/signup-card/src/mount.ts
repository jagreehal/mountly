...
const widget = createWidget(SignupCard, { shadow: true, styles });
...
export function mountSignupCard(container: HTMLElement, props: Record<string, unknown>): void {
...
export function updateSignupCard(container: HTMLElement, props: Record<string, unknown>): void {
