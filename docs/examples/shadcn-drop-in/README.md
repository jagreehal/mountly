...
Open <http://localhost:5177/docs/examples/shadcn-drop-in/>.

## What this proves

- The host page is static HTML + import map only (no React app on the host).
- The widget comes from `docs/examples/signup-card/dist/peer.js` and mounts on intent (`hover` preload, `click` activate).
